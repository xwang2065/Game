...
{
    class EnemyShipType2 : EnemyShip
    {
        public EnemyShipType2(Game game, Texture2D texture, Vector2 position, Scene currentScene) : base(game, texture, position, currentScene)
        {
